    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 h-full">
            ...
            <div className="flex md:hidden col-auto w-full justify-end items-center">
                <div onClick={handelPlay} className="h-10 w-10 flex items-center justify-center rounded-full bg-white p-1 cursor-pointer">
            ...
            <div className="hidden h-full md:flex justify-center items-center w-full max-w-[722px] gap-x-6">
                ...
                <div onClick={handelPlay} className="flex items-center justify-center h-10 w-10 rounded-full bg-white p-1 cursor-pointer">
                    <Icon size={30} className="text-black"/>
                </div>
